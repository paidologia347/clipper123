...
The web app will run at `http://localhost:5000`. Open it in any browser.
...
YT Short Clipper is also available as a **web application** that runs in your browser. The web version preserves all functionality of the desktop app:

- All AI provider configurations (10+ providers)
- Real-time progress updates via WebSocket
- Video download, highlight detection, clipping
- Caption generation (Whisper), Hook generation (TTS)
- Face tracking (OpenCV / MediaPipe)
- Watermark & credit watermark
- GPU acceleration
- Session browser with video playback & download
